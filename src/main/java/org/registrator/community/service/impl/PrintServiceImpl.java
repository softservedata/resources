...
public class PrintServiceImpl implements PrintService {
	...
	@Override
	public ByteArrayOutputStream printProcuration(Integer inquiryId) {
		...
		if (inquiry.getInquiryType().equals(InquiryType.OUTPUT)) {
			...
			try {
				...
				logger.error("Failed to run printProcuration() " + e);
			}
		}
		return document;
	}
	...
	private MandatToExtractDTO createMandatToExractDto(int inquiryId) {
		...
		try {
			...
			logger.error("Failed to run MandatToExractDto() " + e);
		}
	...
	private HeaderDTO createMandateToExtractHeader() {
		...
		try {
			...
			logger.error("Failed to run createMandateToExtractHeader() " + e);
		}
	...
	private ByteArrayOutputStream createMandatToExtractPdf(MandatToExtractDTO extract, HeaderDTO header)
		...
		try {
			...
			logger.error("Failed to run createMandatToExtractPdf() " + e);
		}
		return bos;
	}
	 ...
	 */
	@Override
	public ByteArrayOutputStream printExtract(Integer inquiryId) {
		ByteArrayOutputStream document = null;
		...
		try {
			...
			logger.error("Failed to run printExtract() " + e);
		}
		return document;
	}
	...
	private HeaderDTO createExtractHeader() {
		...
		try {
			...
			logger.error("Failed to run createExtractHeader() " + e);
		}
	...
	private ExtractDTO createExractDto(int inquiryId) {
		...
		try {
			...
			logger.error("Failed to run createExractDto() " + e);
		}
		return extract;
	}
	...
	private ByteArrayOutputStream createExtractPdf(ExtractDTO extract, HeaderDTO header)
		...
		try {
			...
			logger.error("Failed to run createExtractPdf() " + e);
		}
		return bos;
	}
	...
	public PdfPTable createExtractTable(ExtractDTO extract) {
		...
		try {
			...
			logger.error("Failed to run createExtractTable() " + e);
		}
	...
	private HeaderDTO createMandateToInputHeader() {
		...
		try {
			...
			logger.error("Failed to run createMandateToInputHeader() " + e);
		}
	...
	private ByteArrayOutputStream createInputPdf(InputDTO extract, HeaderDTO header)
		...
		try {
			...
			logger.error("Failed to run createInputPdf() " + e);
		}
		return bos;
	}
	...
	private InputDTO createInputDto(int inquiryId) {
		...
		try {
			...
			logger.error("Failed to run createInputDto() " + e);
		}
		return extract;
	}
	...
	public PdfPTable createInputTable(InputDTO extract) {
		...
		try {
			...
			logger.error("Failed to run createInputTable() " + e);
		}
		return table;
	}
	...
	@Override
	public ByteArrayOutputStream printProcurationOnSubmitInfo(Integer inquiryId) {
		...
		try {
			...
			logger.error("Failed to run printProcurationOnSubmitInfo() " + e);
		}
		return document;
	}
