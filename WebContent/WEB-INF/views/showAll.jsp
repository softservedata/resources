...
<body>
	<a
		href="http://localhost:8080/resources/registrator/resourcetypes/add-resource-types">Щоб
		додати новий тип ресурсу, натисніть тут</a>
	<a
		href="http://localhost:8080/resources/registrator/resourcetypes/add-resource-types">Редагувати
		тип ресурсу</a>
	<a
		href="http://localhost:8080/resources/registrator/resourcetypes/add-resource-types">Видалити
		тип ресурсу</a>
	<br />
			...
			<c:if test="${not empty listOfResourceType}">
				<c:forEach items="${listOfResourceType}" var="restype">
					<tr>
						...
						<td><a href="edit/${restype.typeName}">Edit </a> <a
							href="delete/${restype.typeName}.json">Delete</a>
					</tr>
				</c:forEach>
			</c:if>
