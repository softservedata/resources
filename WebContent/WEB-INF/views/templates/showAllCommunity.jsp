				...
				<tr>
					...
					<td style="text-align: center; width: 100%;">
						<div
							...
							<a href="editCommunity?id=${commun.territorialCommunityId}"
								class="btn btn-primary" style="width: 100%;" id="editcommunity"
								role="button"><spring:message code="label.community.edit" />
							</a>
						</div>
						<div
							style="display: inline-block; margin: 2px auto; width: 45%; min-width: 94px;">
							<a href="deleteCommunity/${commun.territorialCommunityId}"
								class="btn btn-danger" style="width: 100%;" id="deletecommunity"
								role="button"><spring:message code="label.community.delete" />
							</a>
						</div>
					</td>
				</tr>
