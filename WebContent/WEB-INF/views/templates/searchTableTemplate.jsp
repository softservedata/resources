                ...
                <th>
                  <div class="form-group">
                    <div class="col-md-12" style="padding: 0">
                      <input type="hidden"
                        id="searchTypeIndex${entry.key}" name="category"
                        value="like" /> <input maxlength="50"
        ...
        <tbody id="user-list">
          <c:if test="${not empty userList}">
            <c:forEach items="${userList}" var="user">
              <tr>
                <td><input class="logindata" type="hidden"
                  name="userLogin" value="${user.login}" />${user.lastName}</td>
