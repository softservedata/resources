...
<div class="container">
    ...
    <form:form id="addResource" method="POST"
        ...
        <input class="polygonId" name="resourceId" value="${resource.resourceId}">
            ...
            <c:if test="${firstPoint != 0}">
                <c:forEach items="${resource.resourceArea.poligons}" var="polygon" varStatus="polygonStatus">
                    ...
                    <div id="polygon_${polygonIndex+1}">
                        <input class="polygonId" name="resourceArea.poligons[${polygonIndex}].polygonId" value="${polygon.polygonId}">
                        <h4>
