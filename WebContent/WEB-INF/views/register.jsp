    ...
    <form class="form-horizontal" id="register_form" role="form" method="get" action="/registrator/register2">
        ...
        <div class="personal_content content">
            ...
            <p>
              ...
              <input name="login" type="text" class="form-control login" id="username" tabindex="100" />
            </p>
            <p>
            ...
            <p>
               ...
               <input name="published_by_data" type="text" class="form-control login" id="passport_published_by_data" tabindex="100" />
            </p>
            </div>
            <p>
...
register.user.passport = Пасспорт *
register.user.passport_number = Серия пасспорта *
...
register.user.username = Логін (нік користувача) *
register.user.password = Пароль *
